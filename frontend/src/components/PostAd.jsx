...
// Define a new styled Card with aesthetic gradient background and smooth corners
const StyledCard = styled(Card)(({ theme }) => ({
  maxWidth: 900,
  margin: "3rem auto",
  padding: theme.spacing(6),
...
// Button with a professional look using gradient and smooth hover effects
const StyledButton = styled(Button)(({ theme }) => ({
  marginTop: theme.spacing(3),
  borderRadius: "12px",
  padding: "14px 28px",
...
// Consistent input field styles with rounded borders and soft hover effects
const StyledFormControl = styled(FormControl)(() => ({
  "& .MuiOutlinedInput-root": {
    borderRadius: "12px",
    transition: "all 0.3s ease",
